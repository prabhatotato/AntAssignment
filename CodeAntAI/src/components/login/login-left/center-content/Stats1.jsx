...
function Stats1() {
  return (
    <div
      ...
      style={{
        boxShadow:
          "0px 10px 20px rgba(0, 0, 0, 0.15), 0px -4px 10px rgba(0, 0, 0, 0.1)",
      }}
    >
      {/* Upper Section */}
      <div className="w-full border-b border-b-[#d8dae5] px-6">
        <div className="flex items-center justify-start">
          ...
          <span>
            <p className="p-4 text-[#081735] font-inter text-lg font-bold leading-7 text-left">
      ...
      <div className="flex justify-between px-6 w-full mt-2">
        ...
        <div className="flex flex-col items-center">
          <span className="text-lg font-bold leading-7 text-gray-900 font-inter">
            10K+
          </span>
          <span className="text-sm font-normal text-gray-500 font-inter">
            Developers
